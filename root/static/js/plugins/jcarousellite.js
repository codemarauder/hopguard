...
$.fn.jCarouselLite = function(options) {
  ...
  console.log("the final options are ",o);
  this.each(function() {
      ...
      if ( o[btn] ) {
        ...
        o['$' + btn].bind('click.jc', function() {
          ...
          if (o.directional) {
            ...
            console.log("the button clicked is " , btn);
          }
          console.log("the go function for the j carousal is being called");
          return go( step );
        });
      }
    });
    ...
    function go(to) {
      ...
      if (o.circular) {
        ...
        console.log("the visible cell is ",visibleCeil);
        console.log("the item length is ",itemLength);
        console.log("the o.scroll is ",o.scroll);
        if (to <= start - visibleCeil - 1) {
          ...
          console.log("the value of curr is when moving from first to last ",curr);
          //curr = -1 ;
    ...
    .bind('endCarousel.jc', function() {
      ...
      if (o.btnPrev) {
        ...
        o.$btnPrev.removeClass(o.btnDisabledClass).unbind('.jc');
      }
      if (o.btnNext) {
        //o.$btnNext.addClass(o.btnDisabledClass).unbind('.jc');
        o.$btnNext.removeClass(o.btnDisabledClass).unbind('.jc');
        o.$btnNext.unbind('.jc');
      }
      if (o.btnGo) {
        $.each(o.btnGo, function(i, val) {
