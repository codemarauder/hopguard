...
;(function($) {
	...
	var methods = {
		init: function(options) {
			console.log("the raty element is",this,$(this));
...
//				$this.children('img').tipTip();
			...
			$this.css('cursor', 'default').data('readonly', 'readonly').removeAttr('title').children('img').attr('title', hint).tipTip();
